...
```{r echo=FALSE}
riverquality<- read.csv("C:/Users/angel/Documents/GitHub/Group6-Project/Data/river-water-quality-trends-20082017-19982017-and-19902017.csv")
cleaned<- riverquality[,c("s_id","np_id_name","np_id_units","n_obs","dominant_landcover","long","lat","trend_category2","percent_annual_change2")]
...
write.csv(readydata,"C:/Users/angel/Documents/GitHub/Group6-Project/Data/transition.csv")

cleaned<- read.csv("C:/Users/angel/Documents/GitHub/Group6-Project/Data/transition.csv")
colnames(cleaned)[1]<-"num_id"
write.csv(cleaned,"C:/Users/angel/Documents/GitHub/Group6-Project/Data/cleaned.csv")
