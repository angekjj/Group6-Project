...
```{r}
riverquality<-read.csv("ms4cleaned.csv")
riverquality<-riverquality[,-1]
rq08<-read.csv("rq08.csv")
rq90<-read.csv("rq90.csv")
rq98<-read.csv("rq98.csv")
...
```{r equality}
waterq<-read.csv("ms4cleaned.csv", header=T)
...
```{r equality 90}
waterq90<-read.csv("rq90.csv", header=T)
...
```{r equality 98}
waterq98<-read.csv("rq98.csv", header=T)
